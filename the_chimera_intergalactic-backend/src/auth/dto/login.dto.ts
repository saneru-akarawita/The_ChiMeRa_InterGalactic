...
export class TravelerLoginDto {
  @DoesAccoutnExist('TRAVELER', {
    message: 'Email is not associated with an intergalactic traveler account',
  })
  @IsEmail()
...
export class AdminLoginDto {
  @DoesAccoutnExist('ADMIN', {
    message: 'Email is not associated with an intergalactic admin account',
  })
  @IsEmail()
  readonly email: string;
